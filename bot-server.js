...
const CONFIG = {
  ...
  PAPER_TRADING:   true,
  WATCHLIST: [
    "RELIANCE"," HDFCBANK"," ICICIBANK"," INFY"," TCS"," LT"," SBIN"," BHARTIARTL"," ITC"," KOTAKBANK"," AXISBANK"," BAJFINANCE"," HINDUNILVR"," TITAN"," SUNPHARMA"," MARUTI"," NESTLEIND"," POWERGRID"," NTPC"," ULTRACEMCO"," ADANIENT"," ADANIPORTS"," ADANIGREEN"," ASIANPAINT"," BAJAJFINSV"," BAJAJ-AUTO"," CIPLA"," COALINDIA"," DIVISLAB"," DRREDDY"," EICHERMOT"," GRASIM"," HCLTECH"," HINDALCO"," JSWSTEEL"," M&M"," ONGC"," TATASTEEL"," TECHM"," WIPRO"," TATAMOTORS"," TATACONSUM"," HDFCLIFE"," INDUSINDBK"," BRITANNIA"," HEROMOTOCO"," APOLLOHOSP"," BEL"," HAL"," SIEMENS"," LTIM"," PERSISTENT"," MPHASIS"," MOTHERSON"," DMART"," JINDALSTEL"," TATAPOWER"," IOC"," BPCL"," GAIL"," VEDL"," ZOMATO"," IRCTC"
  ],
  UNSAFE_WINDOWS: [
